...
if not os.path.exists(os.path.join(root_path, "Reports")):
    os.mkdir(os.path.join(root_path, "Reports"))
...
#For Quandl
api_key = ""
r = rep(fname=os.path.join(root_path, "Reports", "Report_{}.pdf".format(str(end_date))),fund_name=fund_name, logo_path=os.path.join(root_path, "Reports", "rif.jpg"))
