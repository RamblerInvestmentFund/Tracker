...
def min_var(symbols):
    print(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv"))
    if os.path.exists(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv")):
        port_rets = pd.read_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv"), index_col= 0)
