...
def correl(type='data'):
    ...
    if os.path.exists(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv")) and os.path.exists(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Daily_Prices.csv")):
        type = type.lower()
        if type == "returns":
            pdata = pd.read_csv(
                os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv"), index_col=0)
            n = len(pdata.columns) - 1
            pdata = pdata.iloc[:, 0:n]
        else:
            pdata = pd.read_csv(
                os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Daily_Prices.csv"), index_col=0)
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(root_path, "Figures", "port_correl.png"))
...
def weights_plot():
    if os.path.exists(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Weights.csv")):
        port_weights = pd.read_csv(
            os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Weights.csv"), index_col=0)
