...
def rebalance(allocations):
    if os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio_Value.csv') and os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio_Daily_Prices.csv'):
        port_val = pd.read_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Value.csv"), index_col =0)
        port_prices = pd.read_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Daily_Prices.csv"), index_col =0)
