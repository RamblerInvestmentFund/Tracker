...
def info(s = symbols):
    ...
    Asset_exposure.to_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Asset exposure.csv"), index=True)
    ...
    Sectoral_weights.to_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Sectoral Weights.csv"), index=True)
    ...
    plt.savefig(os.path.join(root_path, "Figures", "sec_ind.png"))
