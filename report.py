...
class rep():
    ...
    def perf(self):
        ...
        #Draw price chart
        c.drawImage(os.path.join(root_path, "Figures", "port_perf.png"),x=50, y=50,width=400,height=400,preserveAspectRatio=1)
        ...
        df = pd.read_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv"))
