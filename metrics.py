...
def fundis(rate, method):
    ...
    os.path.join(root_path, "Daily Data", "Benchmark", "Benchmark Returns.csv")) \
        ...
        if os.path.exists(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio_Returns.csv")):
            ...
            #Save data
            weighted_metrics.to_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Portfolio Fundis.csv"))
            fundis.to_csv(os.path.join(root_path, "Daily Data", "Portfolio", "Asset Fundis.csv"))
